...
const Passengers = () => {
  const steps = [
    ...
    {
      icon: <Route className="w-12 h-12 text-green-500" />,
      title: "Efficient Routing",
      description: "Optimize your routes to save time and fuel."
    },
    {
      icon: <Fuel className="w-12 h-12 text-green-500" />,
      title: "Fuel Savings",
  ...
  return (
    <div className="py-12 md:py-16 lg:py-20 xl:py-24 px-4 max-w-6xl mx-auto">
      <h2 className="text-4xl font-bold text-center mb-12 text-blue-700">How It Works for Passengers</h2>
      <p className="text-lg text-center text-gray-600 max-w-3xl mx-auto mb-8">
        Find a reliable and affordable way to travel with our trusted community of drivers.
      </p>
      ...
      <p className="text-center text-gray-600 mt-12 text-lg max-w-3xl mx-auto">
        Booking a ride is seamless and safe. Join today and experience hassle-free, cost-effective travel with verified drivers. Enjoy real-time communication, secure payments, and a smooth ride every time.. Sign up today and start making money on your own schedule.
